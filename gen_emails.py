...
jobs_titles = {
    ...
    Jobs.Android_OS: "Open Source Android Streaming SDK autotests",
...
client_parts = {
    Jobs.Full_Samples: "RX 6600XT Windows 11 (64bit)",
    Jobs.Full_Samples_Android: "Adreno 619 Android (REALME 9 Pro)",
    Jobs.Win_OS: "RX 6600XT Windows 11 (64bit)",
    Jobs.Win_Full: "RX 6600XT Windows 11 (64bit)",
    Jobs.Win_APU: "APU, Ryzen 7000 Windows 11 (64bit)",
    Jobs.Ubuntu_OS: "RX 6600XT Windows 11 (64bit)",
    Jobs.Ubuntu_Full: "RX 6600XT Windows 11 (64bit)",
    Jobs.Android_OS: "RedmiNote12Pro5G Android 13",
...
def generate_first_letter(
    ...
    for job in [
        ...
        for report in Reports:
            ...
            since_date = (
                datetime.today() - timedelta(weeks=2) + timedelta(days=2)
